...
export const LESSONS: Lesson[] = [
  {
    name: 'React Native Firebase Chat Demo',
    slug: 'react-native-firebase-chat-demo',
  ...
  {
    name: 'Realtime Charts with D3',
    slug: 'realtime-charts-d3-firebase',
  ...
  {
    name: 'Animated Notifications with Framer Motion',
    slug: 'react-native-firebase-chat-demo',
